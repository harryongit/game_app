...
const GAMES = [
  { id: 1, name: "Boommine", image: "/boommine.png", link: "/admin/games/boommine/live", description: "Navigate the minefield and multiply your winnings.", color: "neon-blue", shadowColor: "rgba(0,243,255,0.5)" },
  { id: 2, name: "Pro Spin", image: "/prospin.png", link: "/admin/games/spinwheel/live", description: "The ultimate high-stakes spinning experience.", color: "neon-purple", shadowColor: "rgba(176,38,255,0.5)" },
  { id: 3, name: "Spin Wheel", image: "/spin.png", link: "/admin/games/spinwheel/live", description: "Spin the classic wheel for daily rewards.", color: "neon-magenta", shadowColor: "rgba(255,0,255,0.5)" },
  { id: 4, name: "Toss Toss", image: "/toss.png", link: "/admin/games/tosstoss/live", description: "Flip the coin and test your luck.", color: "neon-emerald", shadowColor: "rgba(0,255,102,0.5)" },
];
              ...
              <Link href={game.link} className="block h-full">
                ...
                >
                  ...
                  <div className="mt-auto w-full">
                    <div className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white/5 text-white font-semibold group-hover:bg-white/10 transition-all duration-300 w-full overflow-hidden relative border border-white/10 group-hover:border-white/20"
                         style={{ textShadow: `0 0 8px ${game.shadowColor}` }}>
                      <PlayCircle className="w-5 h-5" style={{ color: `var(--color-${game.color})` }} />
                      <span style={{ color: `var(--color-${game.color})` }}>Play Now</span>
                    </div>
                  </div>
                </div>
              </Link>
