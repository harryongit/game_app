...
const TICKER_ITEMS = [
  { text: "Rahul K. Won ₹1,25,000 on Boommine 🔥", hot: true },
  { text: "Vikram S. Withdrew ₹85,000", hot: false },
  { text: "Pooja M. BIG WIN on Pro Spin", hot: true },
  { text: "Amit D. Claimed VIP Reward", hot: false },
  { text: "Suresh P. 99% Return on Toss Toss", hot: false },
  { text: "Rajesh V. ⚡ HIGH REWARD on Spin Wheel", hot: true },
